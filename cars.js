/*
    ...
    PROJECT RESTRICTION: You can't use forEach, map, reduce, or filter
    to solve these problems.  Only use native JavaScript for loops.
    No other types of loops are allowed.

    PROJECT RESTRICTION: Ensure that you use
    `module.exports = problem1` and not `module.exports = {problem1}`
    and not `module.exports.problem1 = problem1`
    or the `export` keyword. Modules are to be
    imported using `require` and not the `import` keyword.
	...
	Create a new git repo for this project, ensure that you commit after you complete each problem in the project.
	Ensure that the repo is a public repo.

	When you are done, send the repo url to your mentor
*/
